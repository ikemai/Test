...
//
//  Created by Mai Ikeda on 2015/08/10.
    ...
    */
    public func scaledVisibleCells() {
        ...
        case .HorizontalCenter, .HorizontalLeft, .HorizontalRight:
            scaleCellsForHorizontalScroll(self.visibleCells())
            break
        case .VerticalCenter, .VerticalTop, .VerticalBottom:
            self.scaleCellsForVerticalScroll(self.visibleCells())
            break
        }
    }
}
...
extension ScaledVisibleCellsCollectionView {
    ...
    private func scaleCellsForHorizontalScroll(cells: [UICollectionViewCell]) {
    ...
    private func scaleCellsForVerticalScroll(cells: [UICollectionViewCell]) {
